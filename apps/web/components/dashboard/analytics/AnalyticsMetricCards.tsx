...
function buildCards(s: AnalyticsSummary): CardDef[] {
  return [
    {
      label: "Total Events",
    ...
    {
      label: "Last 24 Hours",
      value: s.eventsLast24h.toLocaleString(),
...
export function AnalyticsMetricCards({ summary }: { summary: AnalyticsSummary }) {
  return (
